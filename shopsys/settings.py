...
#settingsFilePath=os.path.abspath(__file__):$(pwd)/settings.py
#os.path.dirname(settingsFilePath):$(pwd)
#==> BASE_DIR: ~/shopsys, manage.py所在目录
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
...
SECRET_KEY = 'nv3dqrinal9ovbm&hh($3x$mb9+-0k_at)(gu(zy@1*(i_e45i'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.2.112',]
...
TEMPLATES = [
    {
        ...
        #'DIRS': [$HOME/shopsys/shopsys/templates],
        'DIRS': [
